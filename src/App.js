    ...
    axios
      ...
      .then(joke => {
        if (!this.isNewJoke(joke, this.state.jokes)) {
          this.setState({
            currentInfo: `Skipped - joke '${getTextPerex(
              joke.value
            )}' already loaded`
          });
          return;
      ...
      <div className="main">
        <div className="main__sidebar sidebar">
          <div className="sidebar__head container heading-img">
            <img
              className="heading-img__img"
              src="images/smiles/smile-32.png"
              alt="smile"
            />
            ...
            <div className="sidebar__section">
              <div className="opening-icon__container">
                <Link className="sidebar__link link-big" to={"/"}>
                  <i className="opening-icon opening-icon--center fa fa-home" />
                  Home
                </Link>
              </div>
              <div className="opening-icon__container">
                <Link className="sidebar__link link-big" to={"/favourites"}>
                  <span className="opening-icon opening-icon--center circle-number circle-number--purple">
                    {this.state.jokesFavourite.length}
                  </span>
                  My favourites
                </Link>
              </div>
              <div className="opening-icon__container">
                <Link className="sidebar__link link-big" to={"/ratings"}>
                  <span className="opening-icon opening-icon--center circle-number circle-number--purple">
                    {this.state.jokesRatings.length}
                  </span>
                  My ratings
                </Link>
              </div>
        ...
        <div className="main__content">
          ...
          <div className="main__content-inner">
                ...
                render={() => (
                  <div className="container">
                    <h2 className="opening-icon__container">
                      <span className="opening-icon circle-number circle-number--purple">
                    ...
                    <Button
                      cssClass="button"
                      onClick={this.handleLoadNewJokesClick}
            ...
            <div className="container">
              <Note text={this.state.currentInfo} />
            </div>
          </div>
        </div>
      </div>
